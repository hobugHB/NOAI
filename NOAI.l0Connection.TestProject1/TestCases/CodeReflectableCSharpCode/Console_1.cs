...
TypeInfoJson="{\"$id\":\"1\",\"ContextGuid\":\"00000000-0000-0000-0000-000000000000\",\"ContextDate\":\"0001-01-01T00:00:00\",\"AssemblyName\":null,\"Namespace\":\"System\",\"IsPublic\":true,\"IsStatic\":true,\"Name\":\"Console\",\"IsPrimitive\":false,\"IsSealed\":true,\"IsVisible\":true,\"IsValueType\":false,\"GUID\":\"34cc8e06-04c2-361d-a47d-874838ca8e3b\",\"Attributes\":1048961,\"HasElementType\":false,\"IsGenericMethodParameter\":false,\"IsGenericParameter\":false,\"IsGenericType\":false,\"IsGenericTypeDefinition\":false,\"IsGenericTypeParameter\":false,\"GenericParameterAttributes\":0,\"GenericParameterPosition\":0,\"GenericTypeArguments\":[],\"IsAbstract\":true,\"IsAnsiClass\":true,\"IsArray\":false,\"IsAutoClass\":false,\"IsAutoLayout\":true,\"IsByRef\":false,\"IsByRefLike\":false,\"IsClass\":true,\"IsCOMObject\":false,\"IsConstructedGenericType\":false,\"IsContextful\":false,\"IsEnum\":false,\"IsExplicitLayout\":false,\"IsImport\":false,\"IsInterface\":false,\"IsLayoutSequential\":false,\"IsMarshalByRef\":false,\"IsNested\":false,\"IsNestedAssembly\":false,\"IsNestedFamANDAssem\":false,\"IsNestedFamily\":false,\"IsNestedFamORAssem\":false,\"IsNestedPrivate\":false,\"IsNestedPublic\":false,\"IsNotPublic\":false,\"IsPointer\":false,\"IsSecurityCritical\":true,\"IsSecuritySafeCritical\":false,\"IsSecurityTransparent\":false,\"IsSerializable\":false,\"IsSignatureType\":false,\"IsSpecialName\":false,\"IsSZArray\":false,\"IsTypeDefinition\":true,\"IsUnicodeClass\":false,\"IsVariableBoundArray\":false,\"AssemblyProperties\":{\"$id\":\"2\",\"Name\":\"System.Console\",\"Version\":\"6.0.0.0\",\"FullName\":\"System.Console, Version=6.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a\",\"CodeBase\":\"file:///C:/Program Files/dotnet/shared/Microsoft.NETCore.App/6.0.1/System.Console.dll\",\"EscapedCodeBase\":\"file:///C:/Program%20Files/dotnet/shared/Microsoft.NETCore.App/6.0.1/System.Console.dll\",\"VersionCompatibility\":1,\"ContentType\":0,\"CultureName\":\"\",\"Flags\":1,\"HashAlgorithm\":32772,\"KeyPair\":null,\"ProcessorArchitecture\":1}}" 
	...
	public static partial class Console
	{
		...
		public static System.Console NOAI_l0Connection_UnderlyingTypeBaseInstance
			...
			Object[] arg)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.WriteLine(
					format,
					arg.NOAI_l0Connection_UnderlyingTypeBaseInstance));
		}
		...
		[UnsupportedOSPlatformAttribute("ios")]
		[UnsupportedOSPlatformAttribute("tvos")]
		public static /*async*/ ConsoleKeyInfo ReadKey(
			)
		{
			return NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				new ConsoleKeyInfo(_NOAI_l0Connection_UnderlyingTypeBaseInstance.ReadKey(
					)));
		}
		...
		[UnsupportedOSPlatformAttribute("ios")]
		[UnsupportedOSPlatformAttribute("tvos")]
		public static /*async*/ void ResetColor(
			)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
		...
		[System.Runtime.Versioning.SupportedOSPlatformAttribute("windows")]
		[SupportedOSPlatformAttribute("windows")]
		public static /*async*/ void SetBufferSize(
			System.Int32 width,
			System.Int32 height)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.SetBufferSize(
					width,
					height));
		}
		...
		[System.Runtime.Versioning.SupportedOSPlatformAttribute("windows")]
		[SupportedOSPlatformAttribute("windows")]
		public static /*async*/ void SetWindowPosition(
			System.Int32 left,
			System.Int32 top)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.SetWindowPosition(
					left,
					top));
		}
		...
		[System.Runtime.Versioning.SupportedOSPlatformAttribute("windows")]
		[SupportedOSPlatformAttribute("windows")]
		public static /*async*/ void SetWindowSize(
			System.Int32 width,
			System.Int32 height)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.SetWindowSize(
					width,
					height));
		}
		...
		[UnsupportedOSPlatformAttribute("ios")]
		[UnsupportedOSPlatformAttribute("tvos")]
		public static /*async*/ ValueTuple<System.Int32, System.Int32> GetCursorPosition(
			)
		{
			return NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
		...
		[System.Runtime.Versioning.SupportedOSPlatformAttribute("windows")]
		[SupportedOSPlatformAttribute("windows")]
		public static /*async*/ void MoveBufferArea(
		...
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.MoveBufferArea(
					sourceLeft,
					sourceTop,
					sourceWidth,
					sourceHeight,
			...
			ConsoleColor sourceBackColor)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.MoveBufferArea(
					...
					targetTop,
					sourceChar,
					sourceForeColor.NOAI_l0Connection_UnderlyingTypeBaseInstance,
					sourceBackColor.NOAI_l0Connection_UnderlyingTypeBaseInstance));
		}
		...
		[UnsupportedOSPlatformAttribute("ios")]
		[UnsupportedOSPlatformAttribute("tvos")]
		public static /*async*/ void SetCursorPosition(
			System.Int32 left,
			System.Int32 top)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.SetCursorPosition(
					left,
					top));
		}
		...
		//[System.Runtime.CompilerServices.NullableContextAttribute(2)]
		//[NullableContextAttribute(2)]
		public static /*async*/ void add_CancelKeyPress(
			ConsoleCancelEventHandler value)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.add_CancelKeyPress(
					value.NOAI_l0Connection_UnderlyingTypeBaseInstance));
		}
		...
		//[System.Runtime.CompilerServices.NullableContextAttribute(2)]
		//[NullableContextAttribute(2)]
		public static /*async*/ void remove_CancelKeyPress(
			ConsoleCancelEventHandler value)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.remove_CancelKeyPress(
					value.NOAI_l0Connection_UnderlyingTypeBaseInstance));
		}
		...
		[UnsupportedOSPlatformAttribute("ios")]
		[UnsupportedOSPlatformAttribute("tvos")]
		public static /*async*/ Stream OpenStandardInput(
			)
		{
			return NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				new Stream(_NOAI_l0Connection_UnderlyingTypeBaseInstance.OpenStandardInput(
					)));
		}
		...
		public static /*async*/ Stream OpenStandardOutput(
			)
		{
			return NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				new Stream(_NOAI_l0Connection_UnderlyingTypeBaseInstance.OpenStandardOutput(
					)));
		}
		...
		public static /*async*/ Stream OpenStandardError(
			)
		{
			return NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				new Stream(_NOAI_l0Connection_UnderlyingTypeBaseInstance.OpenStandardError(
					)));
		}
		...
		[UnsupportedOSPlatformAttribute("ios")]
		[UnsupportedOSPlatformAttribute("tvos")]
		public static /*async*/ void SetIn(
			TextReader newIn)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.SetIn(
					newIn.NOAI_l0Connection_UnderlyingTypeBaseInstance));
		}

		/// 
		public static /*async*/ void SetOut(
			TextWriter newOut)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.SetOut(
					newOut.NOAI_l0Connection_UnderlyingTypeBaseInstance));
		}

		/// 
		public static /*async*/ void SetError(
			TextWriter newError)
		{
			NOAI_l1Runtime_IOCenterContext.Instance.Enter(()=>
				_NOAI_l0Connection_UnderlyingTypeBaseInstance.SetError(
					newError.NOAI_l0Connection_UnderlyingTypeBaseInstance));
		}
